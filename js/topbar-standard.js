...
function isWortschatzPage(){return /\/wortschatz\//.test(path())}
...
function backHref(){
  if(isTaskPage())return 'index.html';
  if(isThemePage())return '../index.html';
  if(isWortschatzLessonPage())return '../index.html';
  if(isVerbenPage()||isFragenPage())return '/index.html';
