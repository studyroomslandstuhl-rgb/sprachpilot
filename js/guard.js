...
const HAS_OWN_PROGRESS_SYSTEM=IS_L3T2||IS_L5||IS_L6T2||IS_L6T3||IS_L6T4||IS_L7||IS_L8||IS_L9;
...
if(FULL_FIREBASE){
 ...
 if(!IS_L6T3&&!IS_L7&&!IS_L8&&!IS_L9){const scoringDelay=IS_L5?1800:300;setTimeout(()=>{import("/js/scoring.js?v=20260831-central3").catch(()=>{})},scoringDelay)}
}
