// data/a1-verb-expansion.js
// Neue typische A1-Verben mit Niveau, Kategorie, Sätzen, Übersetzungen und Konjugationsdaten.
(function(){
  const NEW_A1_VERBS=[
    {v:'heißen',img:'heissen',level:'A1',type:'normal'},
    {v:'aufstehen',img:'aufstehen',level:'A1',type:'separable'},
    {v:'frühstücken',img:'fruehstuecken',level:'A1',type:'normal'},
    {v:'duschen',img:'duschen',level:'A1',type:'normal'},
    {v:'anziehen',img:'anziehen',level:'A1',type:'separable'},
    {v:'ausziehen',img:'ausziehen',level:'A1',type:'separable'},
    {v:'einsteigen',img:'einsteigen',level:'A1',type:'separable'},
    {v:'aussteigen',img:'aussteigen',level:'A1',type:'separable'},
    {v:'umsteigen',img:'umsteigen',level:'A1',type:'separable'},
    {v:'ankommen',img:'ankommen',level:'A1',type:'separable'},
    {v:'abfahren',img:'abfahren',level:'A1',type:'separable'},
    {v:'holen',img:'holen',level:'A1',type:'normal'},
    {v:'zahlen',img:'zahlen',level:'A1',type:'normal'},
    {v:'ausfüllen',img:'ausfuellen',level:'A1',type:'separable'},
    {v:'anmelden',img:'anmelden',level:'A1',type:'reflexive-separable'},
    {v:'mitkommen',img:'mitkommen',level:'A1',type:'separable'},
    {v:'zurückkommen',img:'zurueckkommen',level:'A1',type:'separable'},
    {v:'sitzen',img:'sitzen',level:'A1',type:'normal'},
    {v:'liegen',img:'liegen',level:'A1',type:'normal'},
    {v:'hängen',img:'haengen',level:'A1',type:'normal'},
    {v:'stellen',img:'stellen',level:'A1',type:'normal'},
    {v:'legen',img:'legen',level:'A1',type:'normal'},
    {v:'können',img:'koennen',level:'A1',type:'modal'},
    {v:'müssen',img:'muessen',level:'A1',type:'modal'},
    {v:'wollen',img:'wollen',level:'A1',type:'modal'},
    {v:'dürfen',img:'duerfen',level:'A1',type:'modal'},
    {v:'sollen',img:'sollen',level:'A1',type:'modal'},
    {v:'möchten',img:'moechten',level:'A1',type:'modal'},
    {v:'mögen',img:'moegen',level:'A1',type:'modal'},
    {v:'biegen',img:'biegen',level:'A2',type:'normal'},
