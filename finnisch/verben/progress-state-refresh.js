...
function syncSoon(){
 ...
 setTimeout(()=>{queued=false;try{window.SPFinnishVerbFirebaseSync?.schedule?.(0)}catch(e){}},0);
}
...
new MutationObserver(syncSoon).observe(document.documentElement,{childList:true,subtree:true,characterData:true});
