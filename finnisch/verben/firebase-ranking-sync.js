...
async function getProgress(){if(!window.SPProgress){try{await import('/js/progress.js?v=fi-verben-ranking1')}catch{}}try{return await window.SPProgress?.loadCurrentStudentProgress?.()||{}}catch{return{}}}
...
window.SPFinnishVerbFirebaseSync={sync,schedule};
