import { getActiveProfile, getActiveRole, dashboardHref } from '/js/auth.js?v=verben-test-clean-2';
import { loadCourseRelease, moduleOpen } from '/js/course-releases.js?v=verben-test-clean-2';
import { db, doc, getDoc, setDoc } from '/js/firebase.js?v=verben-test-clean-2';
