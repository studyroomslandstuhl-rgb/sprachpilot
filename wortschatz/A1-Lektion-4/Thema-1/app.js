...
function header(title,isThemeOverview=false){
 ...
 h.innerHTML=`<a class="brand" href="/index.html"><div class="logo"><img class="sp-logo-img" src="/assets/logo/sprachpilot-logo.png" alt="SprachPilot"></div><div><h1>SprachPilot</h1><div class="subtitle">${title} · A1 Lektion 4 · Thema 1</div></div></a>
 <nav class="nav">
