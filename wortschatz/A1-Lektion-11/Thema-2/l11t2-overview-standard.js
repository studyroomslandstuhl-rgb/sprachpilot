...
const items=(D.cards||[]).map(w=>({id:w.id,term:w.full,full:w.full,plural:w.plural||'',type:'noun',image:w.image,audio:w.audio,audioFile:(w.audio||'').split('/').pop()||'',translations:w.translations||{}}));
