...
const T={
 ...
 autovermietung:{en:'car rental',ru:'прокат автомобилей',tr:'araç kiralama',uk:'прокат автомобілів',ar:'تأجير السيارات',ja:'レンタカー会社',ro:'închirieri auto',pl:'wypożyczalnia samochodów',ku:'kirêkirina erebeyan'},
 hingehen:{en:'to go there',ru:'пойти туда',tr:'oraya gitmek',uk:'піти туди',ar:'يذهب إلى هناك',ja:'そこへ行く',ro:'a merge acolo',pl:'iść tam',ku:'çûn wir'},
 laden:{en:'to load',ru:'загружать',tr:'yüklemek',uk:'завантажувати',ar:'يحمّل',ja:'積み込む',ro:'a încărca',pl:'ładować',ku:'bar kirin'},
 wartebereich:{en:'waiting area',ru:'зона ожидания',tr:'bekleme alanı',uk:'зона очікування',ar:'منطقة انتظار',ja:'待合スペース',ro:'zonă de așteptare',pl:'poczekalnia / strefa oczekiwania',ku:'cihê bendê'},
 doch:{en:'after all / emphatic particle',ru:'же / всё-таки',tr:'ya / hadi',uk:'же / все-таки',ar:'أداة للتأكيد',ja:'やっぱり / 強調',ro:'totuși / particulă de accent',pl:'przecież / jednak',ku:'belê / ji bo tekez kirin'},
 ...
 mal:{en:'just / once (softening particle)',ru:'-ка / как-нибудь',tr:'bir / hadi',uk:'-но / якось',ar:'أداة للتلطيف',ja:'ちょっと / 〜してみて',ro:'puțin / particulă de atenuare',pl:'no / raz',ku:'carek / ji bo nermkirinê'}
};
