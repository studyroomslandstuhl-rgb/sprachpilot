...
function installHeaderStyle(){
 ...
 style.textContent=`:root{--lesson-main:#6d28d9;--lesson-main-dark:#3b0764;--lesson-soft:#f5f0ff;--lesson-line:#d8b4fe;--lesson-bg:#f7f2ff}html,body.l7t1-l6t4{background:linear-gradient(180deg,var(--lesson-bg),#fff)!important}body.l7t1-l6t4 .topbar{background:linear-gradient(135deg,#4c1d95,#7c3aed)!important;border:0!important;border-radius:0 0 24px 24px!important;box-shadow:0 8px 22px rgba(76,29,149,.18)!important;color:#fff!important}body.l7t1-l6t4 .topbar .brand,body.l7t1-l6t4 .topbar .brand h1,body.l7t1-l6t4 .topbar .subtitle{color:#fff!important}body.l7t1-l6t4 .topbar .account-pill,body.l7t1-l6t4 .topbar .account-link,body.l7t1-l6t4 .topbar .btn.secondary{background:#fff!important;color:#3b0764!important;border:2px solid #e9d5ff!important;border-radius:18px!important;box-shadow:none!important}body.l7t1-l6t4 .topbar .danger-btn{background:#fff!important;color:#991b1b!important;border:2px solid #ef4444!important}.account-btn{cursor:pointer;font:inherit}`;
