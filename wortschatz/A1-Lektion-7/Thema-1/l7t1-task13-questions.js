(function(){
'use strict';
if(window.__SP_L7T1_TASK13_QUESTIONS_1)return;
window.__SP_L7T1_TASK13_QUESTIONS_1=true;
...
const ROWS=[
 ...
 ['Was möchtest du trinken?','Ich möchte einen Tee.',['Ich möchte einen Tee.','Ich kann einen Tee.','Ich will Klavier spielen.','Ich kann sehr gut lesen.'],'Die Frage fragt höflich nach einem Getränkewunsch.'],
...
function transform(theme){
 ...
 task.items=ROWS.map(([prompt,answer,options,hint])=>({
  kind:'choice',
  prompt,
  answer,
  options:[...options],
 ...
 task.task13Revision='l7t1-task13-unique-questions-2026-08-17-v1';
