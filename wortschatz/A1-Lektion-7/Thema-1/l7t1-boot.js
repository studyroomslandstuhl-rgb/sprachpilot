(function(){
'use strict';
const theme=Number(document.body.dataset.theme),page=document.body.dataset.page||'theme',root=document.getElementById('app'),version='l7t1-firebase-progress-v19';
...
load('/shared/sp-cache-epoch.js?v=20260831-sync-device-merge8').catch(()=>{})
 ...
 .then(()=>load('../shared/l7-wrong-queue-v4.js?v=11'))
