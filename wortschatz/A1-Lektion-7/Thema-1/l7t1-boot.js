(function(){
'use strict';
const theme=Number(document.body.dataset.theme),page=document.body.dataset.page||'theme',root=document.getElementById('app'),version='l7t1-no-skip-v7';
