(function(){
'use strict';
if(window.__SP_L7T1_L6_LAYOUT_1)return;
window.__SP_L7T1_L6_LAYOUT_1=true;
...
window.addEventListener('load',()=>{run();setTimeout(run,120);setTimeout(run,450)});
window.L7T1L6Layout={run,decorateTask,decorateTheme,installPureImageBehavior};
})();
