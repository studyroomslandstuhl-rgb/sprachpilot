(function(){
'use strict';
if(window.__SP_L7T4_CUSTOM_UI_LOADER_V2)return;window.__SP_L7T4_CUSTOM_UI_LOADER_V2=true;
let tries=0;
...
function start(){
 if(window.L7&&window.L7S){
  load('/wortschatz/A1-Lektion-7/Thema-4/l7t4-custom-ui.js?v=3')
   .then(()=>load('/wortschatz/A1-Lektion-7/Thema-4/l7t4-listening-ui.js?v=2'))
   .then(()=>{
