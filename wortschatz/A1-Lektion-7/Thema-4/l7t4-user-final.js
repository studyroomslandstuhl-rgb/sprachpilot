(function(){
'use strict';
if(window.__SP_L7T4_USER_FINAL_V1)return;window.__SP_L7T4_USER_FINAL_V1=true;
...
window.L7_THEME_READY=Promise.resolve(window.L7_THEME_READY).then(theme=>{
 ...
 const order=task(theme,'redemittel-ordnen');if(order){order.title='Redemittel ordnen';order.description='Ordne die Redewendungen.';order.instruction='Ordne die Redewendungen.'}
 ...
 theme.contentRevision='l7t4-user-final-20260822-v1';window.L7_THEME=theme;return theme;
});
