(function(){
'use strict';
if(window.__SP_L7T4_FINALIZE_V2)return;window.__SP_L7T4_FINALIZE_V2=true;
...
function rotateCorrect(value,counter){
 if(!value||typeof value!=='object'||value.preserveOrder===true||!Array.isArray(value.options)||value.options.length<2||value.answer==null)return counter;
...
window.L7_THEME_READY=Promise.resolve(window.L7_THEME_READY).then(theme=>{
 ...
 theme.contentRevision='l7t4-finalized-20260822-v2';window.L7_THEME=theme;return theme;
});
})();