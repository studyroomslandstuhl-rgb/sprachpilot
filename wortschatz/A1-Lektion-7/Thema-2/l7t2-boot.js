...
Promise.resolve(window.L7_THEME_READY)
 ...
 .then(()=>{
  ...
  return load(`../shared/l7-ui.js?v=${version}`)
   ...
   .then(()=>load(`l7t2-memory-ui.js?v=1`))
   .then(()=>{window.L7T2MemoryUI?.install?.();return window.L7.renderTaskPage(theme,new URLSearchParams(location.search).get('task'))});
 })
