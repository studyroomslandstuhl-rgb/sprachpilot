(function(){
'use strict';
if(window.__SP_L7T2_EXAM_WRITING_V1)return;
window.__SP_L7T2_EXAM_WRITING_V1=true;

function byId(theme,id){return theme?.tasks?.find(task=>task?.id===id)}
function unique(values){return[...new Set(values.filter(Boolean))]}

const WRITE_VARIANTS=[
 ['Lina hat am Dienstag Deutsch gelernt.','Am Dienstag hat Lina Deutsch gelernt.'],
 ['Ich habe gestern Hausaufgaben gemacht.','Gestern habe ich Hausaufgaben gemacht.'],
 ['Samir hat am Vormittag einen Brief geschrieben.','Am Vormittag hat Samir einen Brief geschrieben.'],
 ['Wir haben am Abend Musik gehört.','Am Abend haben wir Musik gehört.'],
 ['Mia und Tom haben am Samstag Tennis gespielt und danach gegrillt.','Am Samstag haben Mia und Tom Tennis gespielt und danach gegrillt.'],
 ['Du hast gestern einen Film gesehen.','Gestern hast du einen Film gesehen.'],
 ['Nina hat am Abend ein Buch gelesen.','Am Abend hat Nina ein Buch gelesen.'],
 ['Mein Vater hat am Morgen Brot gekauft.','Am Morgen hat mein Vater Brot gekauft.'],
 ['Wir haben in der Pause Deutsch gesprochen.','In der Pause haben wir Deutsch gesprochen.'],
 ['Lea hat am Montag lange gearbeitet.','Am Montag hat Lea lange gearbeitet.'],
 ...
 ['Das Kind hat am Sonntag lange geschlafen.','Am Sonntag hat das Kind lange geschlafen.'],
 ['Wir haben um neun Uhr gefrühstückt.','Um neun Uhr haben wir gefrühstückt.'],
 ['Maria hat am Abend Suppe gekocht und Brot gegessen.','Am Abend hat Maria Suppe gekocht und Brot gegessen.'],
...
const EXAM_ITEMS=[
 ...
 {kind:'choice',context:'___ habe Deutsch gelernt.',prompt:'Welche Form von haben passt?',options:['Ich','Du','Wir','Ihr'],answer:'Ich'},
...
window.L7_THEME_READY=Promise.resolve(window.L7_THEME_READY).then(theme=>{
 ...
 if(exam){
  ...
  exam.exam=true;
  exam.spL7T2ExamRevision='20260817-v1';
 }
 theme.contentRevision='l7t2-standard-20260817-v14';
