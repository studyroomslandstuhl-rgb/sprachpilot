(function(){
'use strict';
if(window.__SP_L7T2_READING_A1_V3)return;
window.__SP_L7T2_READING_A1_V3=true;
...
function mixAbc(items){
 return (items||[]).map(([question,options,answer])=>[question,shuffle(options),answer]);
}
window.L7_THEME_READY=Promise.resolve(window.L7_THEME_READY).then(theme=>{
 ...
 theme.contentRevision='l7t2-reading-a1-20260817-v3';
