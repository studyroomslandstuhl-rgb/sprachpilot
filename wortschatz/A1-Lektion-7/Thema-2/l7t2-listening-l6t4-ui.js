(function(){
'use strict';
if(window.__SP_L7T2_LISTENING_L6T4_V1)return;
window.__SP_L7T2_LISTENING_L6T4_V1=true;

const AUDIO_BASE='https://sprachpilot.b-cdn.net/audio/';

function install(){
  if(!window.L7||!window.L7S||window.L7.__l7t2ListeningL6T4V1)return false;
  const S=window.L7S;
  ...
  window.L7.__l7t2ListeningL6T4V1=true;
  return true;
}
