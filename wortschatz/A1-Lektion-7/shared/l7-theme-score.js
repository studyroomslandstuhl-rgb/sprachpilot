...
const topicId=theme=>`wortschatz-a1-lektion-7-thema-${Number(theme)}`;
const runKey=theme=>`SP_SCORE_RUN_${topicId(theme)}`;
const pid=()=>String(window.L7S?.pid?.()||'student');
const ledgerKey=theme=>`SP_THEME_SCORE_A1_L7_T${Number(theme)}_V${VERSION}_${pid()}`;
