...
const version='l7-wrong-at-end3';
...
Promise.resolve(window.L7_THEME_READY)
 ...
 .then(()=>load(`../shared/l7-theme-score.js?v=3`))
 ...
 .then(()=>{
   if(page==='theme')return load(`../shared/l7-theme-standard.js?v=l7-theme-standard8`).then(()=>window.L7ThemeStandard.render(theme));
