(function(){
'use strict';
if(window.__SP_L7T3_SCHON_EINMAL_UI_V1)return;window.__SP_L7T3_SCHON_EINMAL_UI_V1=true;
function install(){
 if(!window.L7||!window.L7S||window.L7.__spSchonEinmalV1)return false;
 ...
 window.L7.renderTaskPage=render;window.L7.__spSchonEinmalV1=true;return true
}
