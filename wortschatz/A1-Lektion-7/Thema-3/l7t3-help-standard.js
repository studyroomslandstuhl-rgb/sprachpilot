(function(){
'use strict';
if(window.__SP_L7T3_HELP_STANDARD_V2)return;window.__SP_L7T3_HELP_STANDARD_V2=true;
function install(){
 if(!window.L7||!window.L7S||window.L7.__l7t3HelpV2)return false;
 ...
 if(root)new MutationObserver(queue).observe(root,{childList:true,subtree:true,characterData:true});const raw=window.L7.renderTaskPage.bind(window.L7);window.L7.renderTaskPage=function(th,taskId){const r=raw(th,taskId);queue();return r};window.L7.__l7t3HelpV2=true;queue();return true
}
