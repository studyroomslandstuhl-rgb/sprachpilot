(function(){
'use strict';
const theme=Number(document.body.dataset.theme||3),page=document.body.dataset.page||'theme',root=document.getElementById('app'),version='l7t3-retry-v14';
...
load('/shared/sp-cache-epoch.js?v=20260831-sync-device-merge2').catch(()=>{})
 .then(()=>load('/js/progress-role-guard.js?v=20260831-central4'))
 ...
 .then(()=>{window.SPL7WrongQueueV8?.install?.();return load('../shared/l7-theme-score.js?v=20260831-central4')})
 .then(()=>load('../shared/l7-score-repeat-fix.js?v=1'))
 .then(()=>load('../shared/l7-score-live-sync.js?v=20260831-central4'))
