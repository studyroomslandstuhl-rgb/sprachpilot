(function(){
'use strict';
const theme=Number(document.body.dataset.theme||3),page=document.body.dataset.page||'theme',root=document.getElementById('app'),version='l7t3-device-merge-v19';
...
load('/shared/sp-cache-epoch.js?v=20260831-sync-device-merge8').catch(()=>{})
 ...
 .then(()=>load('../shared/l7-run-authority-fix.js?v=1'))
