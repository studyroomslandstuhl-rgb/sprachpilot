(function(){
'use strict';
const theme=Number(document.body.dataset.theme||3),page=document.body.dataset.page||'theme',root=document.getElementById('app'),version='l7t3-retry-v9';
...
Promise.resolve(window.L7_THEME_READY)
 ...
 .then(()=>load('../shared/l7-wrong-queue-v4.js?v=9'))
 .then(()=>{window.SPL7WrongQueueV8?.install?.();return load('../shared/l7-theme-score.js?v=2')})
 ...
 .then(()=>{
  ...
  return load(`../shared/l7-ui.js?v=${version}`)
   ...
   .then(()=>{window.L7T3SpecialUI?.install?.();return load('l7t3-no-repeat-special.js?v=1')})
   .then(()=>{window.L7T3NoRepeatSpecial?.install?.();return load('l7t3-error-selection-fix.js?v=1')})
   ...
   .then(()=>{
    window.SPL7WrongQueueV8?.install?.();window.L7T2MemoryUI?.install?.();window.L7T2EndingsUI?.install?.();window.L7T2AdvancedUI?.install?.();window.L7T3SpecialUI?.install?.();window.L7T3NoRepeatSpecial?.install?.();window.L7T3ErrorSelectionFix?.install?.();window.L7T3HelpStandard?.install?.();window.L7ReadingQueueFix?.install?.();window.L7T3SchonEinmalUI?.install?.();
