(function(){
'use strict';
const theme=Number(document.body.dataset.theme||3),page=document.body.dataset.page||'theme',root=document.getElementById('app'),version='l7t3-device-merge-v15';
...
load('/shared/sp-cache-epoch.js?v=20260831-sync-device-merge3').catch(()=>{})
 .then(()=>load('/js/progress-role-guard.js?v=20260831-central6'))
 ...
 .then(()=>{window.SPL7WrongQueueV8?.install?.();return load('../shared/l7-theme-score.js?v=20260831-central6')})
 .then(()=>load('../shared/l7-score-repeat-fix.js?v=1'))
 .then(()=>load('../shared/l7-score-live-sync.js?v=20260831-central6'))
 ...
 .then(()=>{
  window.L7T3BunnyAudio?.install?.();if(page==='theme')return load('../shared/l7-theme-standard.js?v=l7-theme-standard12').then(()=>window.L7ThemeStandard.render(theme));if(window.L7S)window.L7S.header=()=>'';addOrderPolish();
