(function(){
'use strict';
const theme=Number(document.body.dataset.theme||3),page=document.body.dataset.page||'theme',root=document.getElementById('app'),version='l7t3-retry-v10';
...
Promise.resolve(window.L7_THEME_READY)
 ...
 .then(()=>{
  window.L7T3BunnyAudio?.install?.();if(page==='theme')return load('../shared/l7-theme-standard.js?v=l7-theme-standard10').then(()=>window.L7ThemeStandard.render(theme));if(window.L7S)window.L7S.header=()=>'';addOrderPolish();
