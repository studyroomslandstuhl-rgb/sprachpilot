...
const q=[['Der Film „Schönes Leben“ fängt um ___ an.','20:15 Uhr'],['Die Kita ist von Montag bis Freitag ___.','geöffnet'],['Ich vereinbare einen ___.','Termin'],['Die Bibliothek ist an Feiertagen ___.','geschlossen'],['Vera ist total ___.','fertig'],['jeden ___','Tag'],['jede ___','Woche'],['jedes ___','Wochenende'],['Ich möchte ein Buch ___.','ausleihen'],['Luka geht in die ___.','Krippe'],['Die Öffnungszeiten stehen auf dem ___.','Schild'],['Das Geschäft ist den ganzen ___ geöffnet.','Tag']];
let i=0,score=0;
