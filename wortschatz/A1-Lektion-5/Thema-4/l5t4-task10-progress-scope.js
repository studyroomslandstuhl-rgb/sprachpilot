(function(){
'use strict';
if(window.__SP_L5T4_TASK10_PROGRESS_SCOPE_V2)return;window.__SP_L5T4_TASK10_PROGRESS_SCOPE_V2=true;
...
function scopedTaskKey(file){if(String(file)==='zuordnen.html')return `${CFG.key}_U_${pid()}_zuordnen_v4`;return typeof rawTaskKey==='function'?rawTaskKey(file):`${CFG.key}_${file}`}
window.taskKey=scopedTaskKey;
try{taskKey=scopedTaskKey}catch(e){}
window.SP_L5T4_TASK10_PID=pid;
window.SP_L5T4_TASK10_KEY=()=>scopedTaskKey('zuordnen.html');
})();