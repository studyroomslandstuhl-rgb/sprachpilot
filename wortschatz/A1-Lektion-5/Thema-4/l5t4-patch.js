(function(){
  ...
  patch('kita',{full:'die Kita',word:'Kita',aliases:['die Kita','Kita','der Kindergarten','Kindergarten']})
  patch('jugend',{full:'die Jugend / die Jugendlichen',word:'Jugend / Jugendliche',aliases:['die Jugend','Jugend','die Jugendlichen','Jugendliche','Jugendlichen']})
