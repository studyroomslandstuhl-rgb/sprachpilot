...
const order=[
 ...
 task('brief-beschriften','Briefteile beschriften','✉️','Beschrifte die Teile der Krankmeldung.','Schreibe zu jedem markierten Teil die richtige Bezeichnung mit Artikel.'),
 task('briefteile','Krankmeldung – Briefteile','📝','Beantworte die Fragen zu den Briefteilen.','Schreibe die passende Antwort mit Artikel.'),
 task('brief-fragen-artikel','Briefteile – Fragen','❓','Beantworte die Fragen zu den Briefteilen.','Schreibe die Antwort mit Artikel.'),
...
D.healthTipItems=[
 ...
 {id:'ht3',person:'Vater',problem:'Rückenschmerzen',question:'Mein Vater hat Rückenschmerzen. Was kann man da tun?',tip:'sich ausruhen',answer:'Er soll sich ausruhen.'},
