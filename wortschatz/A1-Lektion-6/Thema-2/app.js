...
{id:'herbst',group:'Jahreszeiten',type:'noun',article:'der',word:'Herbst',full:'der Herbst',image:'herbst.webp',sentence:'Im Herbst regnet es oft.',tr:{en:'autumn',ru:'осень',uk:'осінь',tr:'sonbahar',ar:'الخريف',ja:'秋',ro:'toamnă',pl:'jesień',ku:'payîz'}},
...
{id:'usa',group:'Länder',type:'country',article:'die',word:'USA',full:'die USA',image:'usa.webp',sentence:'Ich wohne in den USA.',from:'Ich komme aus den USA.',tr:{en:'United States',ru:'США',uk:'США',tr:'ABD',ar:'الولايات المتحدة',ja:'アメリカ合衆国',ro:'Statele Unite',pl:'Stany Zjednoczone',ku:'Dewletên Yekbûyî'}},
{id:'japan',group:'Länder',type:'country',article:'',word:'Japan',full:'Japan',image:'japan.webp',sentence:'Ich wohne in Japan.',from:'Ich komme aus Japan.',tr:{en:'Japan',ru:'Япония',uk:'Японія',tr:'Japonya',ar:'اليابان',ja:'日本',ro:'Japonia',pl:'Japonia',ku:'Japonya'}},
{id:'vietnam',group:'Länder',type:'country',article:'',word:'Vietnam',full:'Vietnam',image:'vietnam.webp',sentence:'Ich wohne in Vietnam.',from:'Ich komme aus Vietnam.',tr:{en:'Vietnam',ru:'Вьетнам',uk:'Вʼєтнам',tr:'Vietnam',ar:'فيتنام',ja:'ベトナム',ro:'Vietnam',pl:'Wietnam',ku:'Viyetnam'}},
{id:'polen',group:'Länder',type:'country',article:'',word:'Polen',full:'Polen',image:'polen.webp',sentence:'Ich wohne in Polen.',from:'Ich komme aus Polen.',tr:{en:'Poland',ru:'Польша',uk:'Польща',tr:'Polonya',ar:'بولندا',ja:'ポーランド',ro:'Polonia',pl:'Polska',ku:'Polonya'}},
{id:'bulgarien',group:'Länder',type:'country',article:'',word:'Bulgarien',full:'Bulgarien',image:'bulgarien.webp',sentence:'Ich wohne in Bulgarien.',from:'Ich komme aus Bulgarien.',tr:{en:'Bulgaria',ru:'Болгария',uk:'Болгарія',tr:'Bulgaristan',ar:'بلغاريا',ja:'ブルガリア',ro:'Bulgaria',pl:'Bułgaria',ku:'Bulgaristan'}},
{id:'frankreich',group:'Länder',type:'country',article:'',word:'Frankreich',full:'Frankreich',image:'frankreich.webp',sentence:'Ich wohne in Frankreich.',from:'Ich komme aus Frankreich.',tr:{en:'France',ru:'Франция',uk:'Франція',tr:'Fransa',ar:'فرنسا',ja:'フランス',ro:'Franța',pl:'Francja',ku:'Fransa'}},
{id:'rumaenien',group:'Länder',type:'country',article:'',word:'Rumänien',full:'Rumänien',image:'rumaenien.webp',sentence:'Ich wohne in Rumänien.',from:'Ich komme aus Rumänien.',tr:{en:'Romania',ru:'Румыния',uk:'Румунія',tr:'Romanya',ar:'رومانيا',ja:'ルーマニア',ro:'România',pl:'Rumunia',ku:'Romanya'}}
];
const GRAMMAR=[
