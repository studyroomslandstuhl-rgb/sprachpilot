...
function startMic(btn,callback){
  ...
  let rec;
  try{rec=new SR()}catch(e){if(status)status.textContent="Mikrofon konnte nicht gestartet werden. Bitte schreibe.";return}
  rec.lang="de-DE";
