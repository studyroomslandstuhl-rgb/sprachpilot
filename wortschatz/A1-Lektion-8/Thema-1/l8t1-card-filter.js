(function(){
'use strict';
if(window.__SP_L8T1_CARD_FILTER_4)return;window.__SP_L8T1_CARD_FILTER_4=true;
...
window.L8_CONTENT_READY=Promise.resolve(window.L8_CONTENT_READY).then(themes=>{
 ...
 theme.overviewOnlyItems=overviewOnly;theme.contentRevision='l8t1-card-filter-20260825-v4';theme.iconRevision='l8t1-semantic-icons-v2';if(Number(document.body?.dataset?.theme)===1)window.L8_THEME=theme;return themes;
});
})();