(function(){
'use strict';
if(window.__SP_L8T1_OVERVIEW_EXTRA_V3)return;window.__SP_L8T1_OVERVIEW_EXTRA_V3=true;
...
function grammarBox(){
 ...
 const box=document.createElement('section');box.id='sp-l8-eigen-grammar';box.className='l8-card sp-l8-eigen-grammar';box.innerHTML=`<div class="sp-l8-eigen-kicker">GRAMMATIK</div><h2>eigen-: eigener, eigene, eigenes, eigenen</h2><p><strong>Wichtig:</strong> Lerne <em>eigen-</em> hier immer als ganze Wortgruppe mit Artikel oder Possessivwort und Nomen.</p><div class="sp-l8-eigen-grid"><div><b>der</b><span>ein eigener Beruf<br>mein eigener Beruf</span></div><div><b>die</b><span>eine eigene Firma<br>meine eigene Firma</span></div><div><b>das</b><span>ein eigenes Büro<br>mein eigenes Büro</span></div><div><b>Akk.</b><span>einen eigenen Arbeitsplatz<br>meinen eigenen Arbeitsplatz</span></div><div><b>Plural</b><span>meine eigenen Kollegen<br>unsere eigenen Ideen</span></div></div><p class="sp-l8-eigen-note">Also nicht nur „eigenes“ lernen, sondern z. B. <b>ein eigenes Büro</b> oder <b>mein eigenes Büro</b>.</p>`;
