(function(){
'use strict';
if(window.__SP_L8T2_TASK7_10_20260901_V2)return;
window.__SP_L8T2_TASK7_10_20260901_V2=true;
...
const TASK7={
 ...
 items:[
  input('Wo wohnt Emre?',['Emre wohnt in Köln.','Er wohnt in Köln.','In Köln wohnt Emre.','In Köln wohnt er.'],AUDIO7),
  input('Wie lange wohnt Emre schon in Köln?',['Emre wohnt seit drei Jahren in Köln.','Er wohnt seit drei Jahren in Köln.','Seit drei Jahren wohnt Emre in Köln.','Seit drei Jahren wohnt er in Köln.','Emre wohnt seit 3 Jahren in Köln.','Er wohnt seit 3 Jahren in Köln.','Seit 3 Jahren wohnt Emre in Köln.','Seit 3 Jahren wohnt er in Köln.'],AUDIO7),
  input('Wann ist Emre nach Deutschland gekommen?',['Emre ist vor fünf Jahren nach Deutschland gekommen.','Er ist vor fünf Jahren nach Deutschland gekommen.','Vor fünf Jahren ist Emre nach Deutschland gekommen.','Vor fünf Jahren ist er nach Deutschland gekommen.','Emre ist vor 5 Jahren nach Deutschland gekommen.','Er ist vor 5 Jahren nach Deutschland gekommen.','Vor 5 Jahren ist Emre nach Deutschland gekommen.','Vor 5 Jahren ist er nach Deutschland gekommen.'],AUDIO7),
  input('Wann hat Emre seine Ausbildung angefangen?',['Emre hat seine Ausbildung vor vier Jahren angefangen.','Er hat seine Ausbildung vor vier Jahren angefangen.','Emre hat vor vier Jahren seine Ausbildung angefangen.','Er hat vor vier Jahren seine Ausbildung angefangen.','Vor vier Jahren hat Emre seine Ausbildung angefangen.','Vor vier Jahren hat er seine Ausbildung angefangen.','Emre hat seine Ausbildung vor 4 Jahren angefangen.','Er hat seine Ausbildung vor 4 Jahren angefangen.','Vor 4 Jahren hat Emre seine Ausbildung angefangen.','Vor 4 Jahren hat er seine Ausbildung angefangen.'],AUDIO7),
  input('Wie lange hat die Ausbildung gedauert?',['Die Ausbildung hat zwei Jahre gedauert.','Seine Ausbildung hat zwei Jahre gedauert.','Die Ausbildung hat 2 Jahre gedauert.','Seine Ausbildung hat 2 Jahre gedauert.','Zwei Jahre hat die Ausbildung gedauert.','2 Jahre hat die Ausbildung gedauert.'],AUDIO7),
  input('Wann hat Emre die Ausbildung beendet?',['Emre hat die Ausbildung vor zwei Jahren beendet.','Er hat die Ausbildung vor zwei Jahren beendet.','Emre hat seine Ausbildung vor zwei Jahren beendet.','Er hat seine Ausbildung vor zwei Jahren beendet.','Vor zwei Jahren hat Emre die Ausbildung beendet.','Vor zwei Jahren hat er die Ausbildung beendet.','Emre hat die Ausbildung vor 2 Jahren beendet.','Er hat die Ausbildung vor 2 Jahren beendet.','Vor 2 Jahren hat Emre die Ausbildung beendet.','Vor 2 Jahren hat er die Ausbildung beendet.'],AUDIO7),
  input('Wie lange hat Emre nach der Ausbildung in einem Restaurant gearbeitet?',['Emre hat acht Monate in einem Restaurant gearbeitet.','Er hat acht Monate in einem Restaurant gearbeitet.','Emre hat acht Monate in einem kleinen Restaurant gearbeitet.','Er hat acht Monate in einem kleinen Restaurant gearbeitet.','Emre hat 8 Monate in einem Restaurant gearbeitet.','Er hat 8 Monate in einem Restaurant gearbeitet.','Acht Monate hat Emre in einem Restaurant gearbeitet.','Acht Monate hat er in einem Restaurant gearbeitet.'],AUDIO7),
  input('Seit wann besucht Emre einen Deutschkurs?',['Emre besucht seit einem Jahr einen Deutschkurs.','Er besucht seit einem Jahr einen Deutschkurs.','Seit einem Jahr besucht Emre einen Deutschkurs.','Seit einem Jahr besucht er einen Deutschkurs.','Emre besucht seit 1 Jahr einen Deutschkurs.','Er besucht seit 1 Jahr einen Deutschkurs.','Seit 1 Jahr besucht Emre einen Deutschkurs.','Seit 1 Jahr besucht er einen Deutschkurs.'],AUDIO7),
  input('Seit wann arbeitet Emre im Café?',['Emre arbeitet seit zehn Monaten im Café.','Er arbeitet seit zehn Monaten im Café.','Seit zehn Monaten arbeitet Emre im Café.','Seit zehn Monaten arbeitet er im Café.','Emre arbeitet seit 10 Monaten im Café.','Er arbeitet seit 10 Monaten im Café.','Seit 10 Monaten arbeitet Emre im Café.','Seit 10 Monaten arbeitet er im Café.'],AUDIO7),
  input('Wie lange lernt Emre schon Deutsch?',['Emre lernt seit zwei Jahren Deutsch.','Er lernt seit zwei Jahren Deutsch.','Seit zwei Jahren lernt Emre Deutsch.','Seit zwei Jahren lernt er Deutsch.','Emre lernt seit 2 Jahren Deutsch.','Er lernt seit 2 Jahren Deutsch.','Seit 2 Jahren lernt Emre Deutsch.','Seit 2 Jahren lernt er Deutsch.'],AUDIO7)
 ]
};
...
function apply(theme){
 ...
 theme.contentRevision='l8t2-task7-10-20260901-v2';
 return theme;
}
