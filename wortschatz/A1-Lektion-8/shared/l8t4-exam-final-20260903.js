...
function exam(){
 return {
  ...
  items:[
   I('Schreibe das passende Wort.','befristet','Die Stelle ist nur für drei Monate.','Die Stelle ist nicht dauerhaft.','',{sourceTask:'A1'}),
   ...
   I('Wie lange ist die Stelle?',['vier Monate','für vier Monate'],'Café am Markt: Teilzeit von 8 bis 12 Uhr, montags bis freitags. 14 Euro pro Stunde. Die Stelle ist für vier Monate befristet.','Suche die Information zur Dauer.',{sourceTask:'A7'}),
   I('Wann arbeitet man?',['von 8 bis 12 Uhr','8 bis 12 Uhr','vormittags'],'Café am Markt: Teilzeit von 8 bis 12 Uhr, montags bis freitags. 14 Euro pro Stunde. Die Stelle ist für vier Monate befristet.','Suche die Arbeitszeit.',{sourceTask:'A7'}),
   C('Welche Stelle passt Maria am besten?',['A','B','C','D'],'A','Maria geht vormittags zum Deutschkurs. Nachmittags hat sie Zeit. Sie hat im Café gearbeitet und sucht Teilzeit.\n\nA · Café: Teilzeit, Montag bis Freitag, 14–19 Uhr.\nB · Bäckerei: Teilzeit, Montag bis Freitag, 6–11 Uhr.\nC · Restaurant: Freitag und Samstag, 17–23 Uhr.\nD · Büro: Vollzeit, Montag bis Freitag, 8–16 Uhr.','Vergleiche Arbeitszeit und Stelle.',{sourceTask:'A8'}),
   I('Ist die Stelle befristet?',['nein','Nein','Nein, die Stelle ist dauerhaft.','Die Stelle ist dauerhaft.'],'','Höre auf die Information zur Dauer.',{audio:'Frau: Guten Tag. Ich interessiere mich für die Stelle im Sekretariat. Ist sie befristet? Mann: Nein, die Stelle ist dauerhaft. Frau: Ist es Vollzeit? Mann: Ja, montags bis freitags.',audioFile:'l8t4_telefon_03.mp3',sourceTask:'A9'}),
   ...
   F('Schreibe 3–4 kurze Sätze. Frage nach der Arbeitszeit und dem Verdienst. Schreibe auch, wann du Zeit hast.','Stellenanzeige: Café Sonnig sucht eine Aushilfe im Service. Teilzeit. Die Stelle ist frei.',3)
  ]
 };
}
